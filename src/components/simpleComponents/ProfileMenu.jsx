...
export function ProfileMenu() {
  return (
    ...
    >
      ...
      <MenuList className="bg-primary text-white border border-opacity-10 bg-opacity-30 mt-1 ">
        <MenuItem className="flex items-center gap-2 hover:bg-opacity-15 hover:text-white">
          <svg
            width="16"
            height="16"
            viewBox="0 0 16 16"
        ...
        <Menu placement="left" className="hidden">
          <MenuHandler>
